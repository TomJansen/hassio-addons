...
- Added support for configuring extra environment variables via the `env_vars` add-on option alongside config.yaml. See https://github.com/tomjansen/hassio-addons/wiki/Add-Environment-variables-to-your-Addon-2 for details.
